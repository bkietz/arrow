...
class IoCtxInterface {
 public:
  ...
  /// Read from a RADOS object.
  ///
  /// :param oid: the ID of the object to read.
  /// :param bl: a bufferlist to hold the contents of the read object.
  /// :param len: the length of data to read from the object.
  /// :param offset: the offset to read from in the object.
  arrow::Status read(const std::string& oid, ceph::bufferlist& bl, size_t len,
                     uint64_t offset);
  /// Executes a Ceph Object Class method.
  ///
  /// :param oid: the object ID on which to invoke the CLS function.
  /// :param cls: the name of the object class.
  /// :param method: the name of the object class method.
  /// :param in: a bufferlist to send data to the object class method.
  /// :param out: a bufferlist to receive data from the object class method.
  ...
  ///
  /// :param oid: the object ID on which to call stat.
  /// :param psize[out]: hold the size of the object.
