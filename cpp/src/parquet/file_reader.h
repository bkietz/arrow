...
/// :param columns: the column numbers to scan. If empty scans all
/// :param column_batch_size: number of values to read at a time when scanning column
/// :param reader: a ParquetFileReader instance
