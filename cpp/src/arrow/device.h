 ...
 public:
  ...
  class ARROW_EXPORT SyncEvent {
   public:
    ...
    /// Record the wrapped event on the stream so it triggers
...
/// Register a function to retrieve a MemoryManager for a Device type
///
...
///
/// :param device_type: the device type for which to register a MemoryManager
/// :param mapper: function that takes a device id and returns the appropriate
...
/// Get the registered function to retrieve a MemoryManager for the
/// given Device type
///
