...
class ARROW_EXPORT Codec {
 public:
  ...
  /// Return the smallest supported compression level for the codec
  /// Note: This function creates a temporary Codec instance
  static Result<int> MinimumCompressionLevel(Compression::type codec);

  /// Return the largest supported compression level for the codec
  /// Note: This function creates a temporary Codec instance
  ...
  ///
  /// ```{note}
  /// One-shot decompression is not always compatible with streaming
  ...
  ///
  /// ```{note}
  /// One-shot compression is not always compatible with streaming
