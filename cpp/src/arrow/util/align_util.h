...
/// Special alignment value to use data type-specific alignment
///
...
/// Calculate if the buffer's address is a multiple of `alignment`
///
...
/// Calculate if all buffers in the array data are aligned
///
...
/// Calculate if all buffers in the array are aligned
///
/// This will also check the buffers in the dictionary and any children
...
/// Calculate which (if any) chunks in a chunked array are unaligned
/// :param array: the array to check
/// :param alignment: the alignment (in bytes) to check for
...
/// calculate which (if any) columns in a record batch are unaligned
...
/// calculate which (if any) columns in a table are unaligned
...
/// return a buffer that has the given alignment and the same data as the input
/// buffer
///
...
/// return an array data where all buffers are aligned by the given alignment
///
...
/// return an array where all buffers are aligned by the given alignment
///
/// If any input buffer is already aligned then this method will reuse that same input
/// buffer.
///
...
/// return a chunked array where all buffers are aligned by the given alignment
///
/// If any input buffer is already aligned then this method will reuse that same input
/// buffer.
///
...
/// return a record batch where all buffers are aligned by the given alignment
///
/// If any input buffer is already aligned then this method will reuse that same input
/// buffer.
///
...
/// return a table where all buffers are aligned by the given alignment
///
/// If any input buffer is already aligned then this method will reuse that same input
/// buffer.
///
