...
/// Do vectorized boundschecking of integer-type array indices. The
...
/// Boundscheck integer values to determine if they are all between the
...
/// Use CheckIntegersInRange to determine whether the passed integers
...
/// Convenience for boundschecking a single Scalar value
ARROW_EXPORT
