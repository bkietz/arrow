...
/// :param ctx: CudaContext to allocate device memory from
...
/// :param buffer: a CudaBuffer containing the complete IPC message
/// :param pool: a MemoryPool to use for allocating space for the metadata
