...
class ARROW_EXPORT CudaDeviceManager {
 public:
  ...
  /// :param device_number: the CUDA device number
  ...
  /// :param device_number: the CUDA device number
  /// :param handle: CUDA context handle created by another library
...
/// Return whether a device instance is a CudaDevice
ARROW_EXPORT
bool IsCudaDevice(const Device& device);

/// Cast a device instance to a CudaDevice
///
...
/// Return whether a MemoryManager instance is a CudaMemoryManager
ARROW_EXPORT
bool IsCudaMemoryManager(const MemoryManager& mm);

/// Cast a MemoryManager instance to a CudaMemoryManager
///
...
class ARROW_EXPORT CudaContext : public std::enable_shared_from_this<CudaContext> {
 public:
  ...
  /// :param ipc_handle: opaque pointer to CUipcMemHandle (driver API)
  ...
  /// :param buffer: a CudaBuffer referencing
  /// :return: Status
  ...
  /// Return the device address that is reachable from kernels
  /// running in the context
  /// :param addr: device or host memory address
