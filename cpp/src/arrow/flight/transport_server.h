...
class ARROW_FLIGHT_EXPORT ServerDataStream : public TransportDataStream {
 public:
  /// Attempt to write a non-data message.
  ///
...
/// An implementation of a Flight server for a particular
/// transport.
///
...
class ARROW_FLIGHT_EXPORT ServerTransport {
 public:
  ...
  /// Wait for the server to shutdown (but do not shut down the server).
  ///
  ...
  /// Implement DoGet in terms of a transport-level stream.
  ///
  /// :param context: The server context.
  /// :param request: The request payload.
  /// :param stream: The transport-specific data stream
  ///   implementation. Must implement WriteData(const
  ///   FlightPayload&).
  Status DoGet(const ServerCallContext& context, const Ticket& request,
               ServerDataStream* stream);
  /// Implement DoPut in terms of a transport-level stream.
  ///
  /// :param context: The server context.
  /// :param stream: The transport-specific data stream
  ...
  /// Implement DoExchange in terms of a transport-level stream.
  ///
  /// :param context: The server context.
  /// :param stream: The transport-specific data stream
  ///   implementation. Must implement ReadData(FlightData*)
