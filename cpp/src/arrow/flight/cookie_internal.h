...
/// Case insensitive comparator for use by cookie caching map. Cookies are not
/// case-sensitive.
...
/// Case insensitive hasher for use by cookie caching map. Cookies are not
/// case-sensitive.
...
/// Class to represent a cookie.
class ARROW_FLIGHT_EXPORT Cookie {
 public:
  /// Parse function to parse a cookie header value and return a Cookie object.
  ///
  /// :return: Cookie object based on cookie header value.
  static Cookie Parse(std::string_view cookie_header_value);

  /// Parse a cookie header string beginning at the given start_pos and identify
  /// the name and value of an attribute.
  ///
  /// :param cookie_header_value: The value of the Set-Cookie header.
  /// :param start_pos[out]: An input/output parameter indicating the starting position
  ...
  /// Function to fix cookie format date string so it is accepted by Windows
  ///
  /// parsers.
  ...
  /// Function to get cookie as a string.
  ///
  /// :return: Cookie as a string.
  std::string AsCookieString() const;

  /// Function to get name of the cookie as a string.
  ///
...
/// Class to handle updating a cookie cache.
class ARROW_FLIGHT_EXPORT CookieCache {
 public:
  ...
  /// Retrieve the cached cookie values as a string. This function discards
