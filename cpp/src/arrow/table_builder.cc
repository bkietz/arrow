...
RecordBatchBuilder::RecordBatchBuilder(std::shared_ptr<Schema> schema, MemoryPool* pool,
                                       int64_t initial_capacity)
    : schema_(std::move(schema)), initial_capacity_(initial_capacity), pool_(pool) {}
