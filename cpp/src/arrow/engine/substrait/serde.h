...
/// Serialize an Acero Plan to a binary protobuf Substrait message
///
/// :param declaration: the Acero declaration to serialize.
/// This declaration is the sink relation of the Acero plan.
/// :param ext_set[in,out]: the extension mapping to use; may be updated to add
...
/// Serialize expressions to a Substrait message
///
/// :param bound_expressions: the expressions to serialize.
/// :param conversion_options: options to control how the conversion is done
/// :param ext_set[in,out]: the extension mapping to use, optional, only needed
...
/// Deserializes a Substrait Plan message to a list of ExecNode declarations
///
...
///
/// :param buf: a buffer containing the protobuf serialization of a Substrait Plan
/// message
/// :param consumer_factory: factory function for generating the node that consumes
/// the batches produced by each toplevel Substrait relation
/// :param registry: an extension-id-registry to use, or null for the default one.
/// :param ext_set_out[out]: if non-null, the extension mapping used by the Substrait
/// Plan is returned here.
/// :param conversion_options: options to control how the conversion is to be done.
...
/// Deserializes a single-relation Substrait Plan message to an execution plan
///
/// The output of each top-level Substrait relation will be sent to a caller supplied
/// consumer function provided by consumer_factory
///
/// :param buf: a buffer containing the protobuf serialization of a Substrait Plan
/// message
/// :param consumer: node that consumes the batches produced by each toplevel Substrait
/// relation
/// :param registry: an extension-id-registry to use, or null for the default one.
/// :param ext_set_out[out]: if non-null, the extension mapping used by the Substrait
/// :param conversion_options: options to control how the conversion is to be done.
...
/// :param buf: a buffer containing the protobuf serialization of a Substrait Plan
/// message
/// :param write_options_factory: factory function for generating the write options of
...
/// :param buf: a buffer containing the protobuf serialization of a Substrait Plan
/// message
/// :param write_options: write options of a node consuming the batches produced by
...
/// Deserializes a Substrait Plan message to a Declaration
///
...
/// Deserialize a Substrait ExtendedExpression message to the corresponding Arrow
/// type
///
/// :param buf: a buffer containing the protobuf serialization of a collection of bound
/// expressions
/// :param registry: an extension-id-registry to use, or null for the default one
/// :param conversion_options: options to control how the conversion is done
/// :param ext_set_out[out]: if non-null, the extension mapping used by the Substrait
...
/// Deserializes a Substrait Type message to the corresponding Arrow type
///
/// :param buf: a buffer containing the protobuf serialization of a Substrait Type
/// message
/// :param ext_set: the extension mapping to use, normally provided by the
...
/// Serializes an Arrow type to a Substrait Type message
///
/// :param type: the Arrow data type to serialize
/// :param ext_set[in,out]: the extension mapping to use; may be updated to add a
...
/// Deserializes a Substrait NamedStruct message to an Arrow schema
///
/// :param buf: a buffer containing the protobuf serialization of a Substrait
/// NamedStruct message
/// :param ext_set: the extension mapping to use, normally provided by the
/// surrounding Plan message
/// :param conversion_options: options to control how the conversion is to be done.
...
/// Serializes an Arrow schema to a Substrait NamedStruct message
///
/// :param schema: the Arrow schema to serialize
/// :param ext_set[in,out]: the extension mapping to use; may be updated to add
...
/// Deserializes a Substrait Expression message to a compute expression
///
/// :param buf: a buffer containing the protobuf serialization of a Substrait
/// Expression message
/// :param ext_set: the extension mapping to use, normally provided by the
...
/// Serializes an Arrow compute expression to a Substrait Expression message
///
/// :param expr: the Arrow compute expression to serialize
/// :param ext_set[in,out]: the extension mapping to use; may be updated to add
...
/// Serialize an Acero Declaration to a binary protobuf Substrait message
///
/// :param declaration: the Acero declaration to serialize
/// :param ext_set[in,out]: the extension mapping to use; may be updated to add
/// :param conversion_options: options to control how the conversion is done
...
/// Deserializes a Substrait Rel (relation) message to an ExecNode declaration
///
/// :param buf: a buffer containing the protobuf serialization of a Substrait
/// Rel message
/// :param ext_set: the extension mapping to use, normally provided by the
...
/// Checks whether two protobuf serializations of a particular Substrait message
/// type are equivalent
///
...
///
/// :param message_name: the name of the Substrait message type to check
/// :param l_buf: buffer containing the first protobuf serialization to compare
/// :param r_buf: buffer containing the second protobuf serialization to compare
...
/// Utility function to convert a JSON serialization of a Substrait message to
/// its binary serialization
///
/// :param type_name: the name of the Substrait message type to convert
/// :param json: the JSON string to convert
/// :param ignore_unknown_fields: if true then unknown fields will be ignored and
...
/// Utility function to convert a binary protobuf serialization of a Substrait
/// message to JSON
///
/// :param type_name: the name of the Substrait message type to convert
/// :param buf: the buffer containing the binary protobuf serialization of the message
