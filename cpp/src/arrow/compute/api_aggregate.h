...
///
/// :param options: counting options, see CountOptions for more information
/// :param datum: to count
...
///
/// :param value: datum to compute the mean, expecting Array
/// :param options: see ScalarAggregateOptions for more information
/// :param ctx: the function execution context, optional
...
/// Compute the product of values of a numeric array.
///
/// :param value: datum to compute product of, expecting Array or ChunkedArray
/// :param options: see ScalarAggregateOptions for more information
/// :param ctx: the function execution context, optional
...
///
/// :param value: datum to sum, expecting Array or ChunkedArray
/// :param options: see ScalarAggregateOptions for more information
/// :param ctx: the function execution context, optional
/// :return: datum of the computed sum as a Scalar
///
...
/// Calculate the first value of an array
///
/// :param value: input datum, expecting Array or ChunkedArray
/// :param options: see ScalarAggregateOptions for more information
/// :param ctx: the function execution context, optional
...
/// Calculate the last value of an array
///
/// :param value: input datum, expecting Array or ChunkedArray
/// :param options: see ScalarAggregateOptions for more information
/// :param ctx: the function execution context, optional
...
/// Calculate the min / max of a numeric array
///
...
///
/// :param value: input datum, expecting a boolean array
/// :param options: see ScalarAggregateOptions for more information
/// :param ctx: the function execution context, optional
...
///
/// :param value: input datum, expecting Array or ChunkedArray
/// :param options: see ModeOptions for more information
/// :param ctx: the function execution context, optional
...
///
/// :param value: input datum, expecting Array or ChunkedArray
/// :param options: see VarianceOptions for more information
/// :param ctx: the function execution context, optional
...
///
/// :param value: input datum, expecting Array or ChunkedArray
/// :param options: see QuantileOptions for more information
/// :param ctx: the function execution context, optional
...
/// Calculate the approximate quantiles of a numeric array with T-Digest algorithm
///
/// :param value: input datum, expecting Array or ChunkedArray
/// :param options: see TDigestOptions for more information
/// :param ctx: the function execution context, optional
/// :return: resulting datum as an array
///
/// ```{versionadded} 4.0.0
...
/// :param options: The array to search for. See IndexOptions.
/// :param ctx: the function execution context, optional
